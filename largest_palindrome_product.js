  ...
  if (digits === 2) {
    for (let i=99; i>90; i--) {
      for (let j=i; j>90; j--) {
        ...
        // console.log(pal, '=', palindromeNumber, '?');
        if(pal === palindromeNumber) {
          if (highest < palindromeNumber) {
            highest = palindromeNumber;
...
// push all palindrome objects to result array, loop through result & compare result[k].palindrome to answer.palindrome for higher amount
